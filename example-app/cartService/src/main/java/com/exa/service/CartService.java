...
//  }
  ...
  public void removeItem(Long userId, Long itemId) {
	    ...
	    if (removedItem != null) {
	        ...
	        // 🔄 Call ProductClient to update units in stock
  ...
  public void removeItems(Long userId, List<Long> itemIds) {
	    ...
	    if (!itemsToRemove.isEmpty()) {
	        ...
	        itemsToRemove.forEach(item -> {
	            ...
	            int currentStock = productClient.getProductById(productId).getUnitsInStock();
	            int updatedStock = currentStock + item.getQuantity();
	            productClient.updateUnits(productId, updatedStock);
	        });
	    }
	}
  ...
  public Double getTotal(Long userId) {
	    ...
	    return items.stream()
	        ...
	        .sum(); // 💥 This does the accumulation
	}
...
//  
  ...
  @Transactional
  public void removeOrderedItems(Long userId, List<Long> orderedProductIds) {
